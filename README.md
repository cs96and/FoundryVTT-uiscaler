# UI Scaler for Foundry

## UI SCALER HAS MOVED TO [CODEBERG](https://codeberg.org/cs96and/FoundryVTT-uiscaler)
...
UI Scaler is a Foundry VTT module that allows you to increase or decrease the size of the user interface elements (left sidebar, navigation bar, and macro bar).
